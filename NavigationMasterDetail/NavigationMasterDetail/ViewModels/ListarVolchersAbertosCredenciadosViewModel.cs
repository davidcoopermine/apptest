...
{
    class ListarVolchersFechadosCredenciadosViewModel : NotifyBase
    {


        public ListarVolchersFechadosCredenciadosViewModel()
        {
...

        {
            ...
            try
            {
                ...
                var resp = await client.GetAsync("api/v2/novacloud/_table/vw_Volchers?filter=(owner%3D'"+ ObjLogin.login + "'%20)and(pago%3D'"+ "true" +"'%20)");
